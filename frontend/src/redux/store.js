...
console.log(
  '🚀 Welcome to Cold Coders ERP CRM! Did you know that we also offer commercial customization services? Contact us at hello@coldcodersapp.com for more information.'
);
